...
#include "RuntimeCoreAPI.h"

static std::unique_ptr<test_utils::test_device_registry> Registry;
static const int32_t TargetDeviceId = 0;
static bool bWasConnected = false;
static bool bLogButtons = true;
static bool bLogAnalogs = true;
static bool bLogTouch = true;
static bool bLogSensors = true;

RUNTIMECORE_API void InitSonyGamepad()
{
