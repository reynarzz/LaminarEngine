...
Laminar Engine is a **C#** video game engine built entirely from scratch, heavily inspired by the **Unity3D C# API**.

## Features

- C# Scripting + Hot reloading.
- Cross-platform Editor: Windows, MacOs.
