...
namespace OpenGL
{
    ...
    public static unsafe partial class GL
    {
        ...
        private static T Load<T>(GetProcAddressHandler loader, string name) where T : Delegate
        {
        ...
        {
            _glCullFace = Load<PFNGLCULLFACEPROC>(loader,"glCullFace");
            _glFrontFace = Load<PFNGLFRONTFACEPROC>(loader,"glFrontFace");
            _glHint = Load<PFNGLHINTPROC>(loader,"glHint");
            _glLineWidth = Load<PFNGLLINEWIDTHPROC>(loader,"glLineWidth");
            _glPointSize = Load<PFNGLPOINTSIZEPROC>(loader,"glPointSize");
            _glPolygonMode = Load<PFNGLPOLYGONMODEPROC>(loader,"glPolygonMode");
            _glScissor = Load<PFNGLSCISSORPROC>(loader,"glScissor");
            _glTexParameterf = Load<PFNGLTEXPARAMETERFPROC>(loader,"glTexParameterf");
            _glTexParameterfv = Load<PFNGLTEXPARAMETERFVPROC>(loader,"glTexParameterfv");
            _glTexParameteri = Load<PFNGLTEXPARAMETERIPROC>(loader,"glTexParameteri");
            _glTexParameteriv = Load<PFNGLTEXPARAMETERIVPROC>(loader,"glTexParameteriv");
            _glTexImage1D = Load<PFNGLTEXIMAGE1DPROC>(loader,"glTexImage1D");
            _glTexImage2D = Load<PFNGLTEXIMAGE2DPROC>(loader,"glTexImage2D");
            _glDrawBuffer = Load<PFNGLDRAWBUFFERPROC>(loader,"glDrawBuffer");
            _glClear = Load<PFNGLCLEARPROC>(loader,"glClear");
            _glClearColor = Load<PFNGLCLEARCOLORPROC>(loader,"glClearColor");
            _glClearStencil = Load<PFNGLCLEARSTENCILPROC>(loader,"glClearStencil");
            _glClearDepth = Load<PFNGLCLEARDEPTHPROC>(loader,"glClearDepth");
            _glStencilMask = Load<PFNGLSTENCILMASKPROC>(loader,"glStencilMask");
            _glColorMask = Load<PFNGLCOLORMASKPROC>(loader,"glColorMask");
            _glDepthMask = Load<PFNGLDEPTHMASKPROC>(loader,"glDepthMask");
            _glDisable = Load<PFNGLDISABLEPROC>(loader,"glDisable");
            _glEnable = Load<PFNGLENABLEPROC>(loader,"glEnable");
            _glFinish = Load<PFNGLFINISHPROC>(loader,"glFinish");
            _glFlush = Load<PFNGLFLUSHPROC>(loader,"glFlush");
            _glBlendFunc = Load<PFNGLBLENDFUNCPROC>(loader,"glBlendFunc");
            _glLogicOp = Load<PFNGLLOGICOPPROC>(loader,"glLogicOp");
            _glStencilFunc = Load<PFNGLSTENCILFUNCPROC>(loader,"glStencilFunc");
            _glStencilOp = Load<PFNGLSTENCILOPPROC>(loader,"glStencilOp");
            _glDepthFunc = Load<PFNGLDEPTHFUNCPROC>(loader,"glDepthFunc");
            _glPixelStoref = Load<PFNGLPIXELSTOREFPROC>(loader,"glPixelStoref");
            _glPixelStorei = Load<PFNGLPIXELSTOREIPROC>(loader,"glPixelStorei");
            _glReadBuffer = Load<PFNGLREADBUFFERPROC>(loader,"glReadBuffer");
            _glReadPixels = Load<PFNGLREADPIXELSPROC>(loader,"glReadPixels");
            _glGetBooleanv = Load<PFNGLGETBOOLEANVPROC>(loader,"glGetBooleanv");
            _glGetDoublev = Load<PFNGLGETDOUBLEVPROC>(loader,"glGetDoublev");
            _glGetError = Load<PFNGLGETERRORPROC>(loader,"glGetError");
            _glGetFloatv = Load<PFNGLGETFLOATVPROC>(loader,"glGetFloatv");
            _glGetIntegerv = Load<PFNGLGETINTEGERVPROC>(loader,"glGetIntegerv");
            _glGetString = Load<PFNGLGETSTRINGPROC>(loader,"glGetString");
            _glGetTexImage = Load<PFNGLGETTEXIMAGEPROC>(loader,"glGetTexImage");
            _glGetTexParameterfv = Load<PFNGLGETTEXPARAMETERFVPROC>(loader,"glGetTexParameterfv");
            _glGetTexParameteriv = Load<PFNGLGETTEXPARAMETERIVPROC>(loader,"glGetTexParameteriv");
            _glGetTexLevelParameterfv = Load<PFNGLGETTEXLEVELPARAMETERFVPROC>(loader,"glGetTexLevelParameterfv");
            _glGetTexLevelParameteriv = Load<PFNGLGETTEXLEVELPARAMETERIVPROC>(loader,"glGetTexLevelParameteriv");
            _glIsEnabled = Load<PFNGLISENABLEDPROC>(loader,"glIsEnabled");
            _glDepthRange = Load<PFNGLDEPTHRANGEPROC>(loader,"glDepthRange");
            _glViewport = Load<PFNGLVIEWPORTPROC>(loader,"glViewport");
            _glDrawArrays = Load<PFNGLDRAWARRAYSPROC>(loader,"glDrawArrays");
            _glDrawElements = Load<PFNGLDRAWELEMENTSPROC>(loader,"glDrawElements");
            _glPolygonOffset = Load<PFNGLPOLYGONOFFSETPROC>(loader,"glPolygonOffset");
            _glCopyTexImage1D = Load<PFNGLCOPYTEXIMAGE1DPROC>(loader,"glCopyTexImage1D");
            _glCopyTexImage2D = Load<PFNGLCOPYTEXIMAGE2DPROC>(loader,"glCopyTexImage2D");
            _glCopyTexSubImage1D = Load<PFNGLCOPYTEXSUBIMAGE1DPROC>(loader,"glCopyTexSubImage1D");
            _glCopyTexSubImage2D = Load<PFNGLCOPYTEXSUBIMAGE2DPROC>(loader,"glCopyTexSubImage2D");
            _glTexSubImage1D = Load<PFNGLTEXSUBIMAGE1DPROC>(loader,"glTexSubImage1D");
            _glTexSubImage2D = Load<PFNGLTEXSUBIMAGE2DPROC>(loader,"glTexSubImage2D");
            _glBindTexture = Load<PFNGLBINDTEXTUREPROC>(loader,"glBindTexture");
            _glDeleteTextures = Load<PFNGLDELETETEXTURESPROC>(loader,"glDeleteTextures");
            _glGenTextures = Load<PFNGLGENTEXTURESPROC>(loader,"glGenTextures");
            _glIsTexture = Load<PFNGLISTEXTUREPROC>(loader,"glIsTexture");
            _glDrawRangeElements = Load<PFNGLDRAWRANGEELEMENTSPROC>(loader,"glDrawRangeElements");
            _glTexImage3D = Load<PFNGLTEXIMAGE3DPROC>(loader,"glTexImage3D");
            _glTexSubImage3D = Load<PFNGLTEXSUBIMAGE3DPROC>(loader,"glTexSubImage3D");
            _glCopyTexSubImage3D = Load<PFNGLCOPYTEXSUBIMAGE3DPROC>(loader,"glCopyTexSubImage3D");
            _glActiveTexture = Load<PFNGLACTIVETEXTUREPROC>(loader,"glActiveTexture");
            _glSampleCoverage = Load<PFNGLSAMPLECOVERAGEPROC>(loader,"glSampleCoverage");
            _glCompressedTexImage3D = Load<PFNGLCOMPRESSEDTEXIMAGE3DPROC>(loader,"glCompressedTexImage3D");
            _glCompressedTexImage2D = Load<PFNGLCOMPRESSEDTEXIMAGE2DPROC>(loader,"glCompressedTexImage2D");
            _glCompressedTexImage1D = Load<PFNGLCOMPRESSEDTEXIMAGE1DPROC>(loader,"glCompressedTexImage1D");
            _glCompressedTexSubImage3D = Load<PFNGLCOMPRESSEDTEXSUBIMAGE3DPROC>(loader,"glCompressedTexSubImage3D");
            _glCompressedTexSubImage2D = Load<PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC>(loader,"glCompressedTexSubImage2D");
            _glCompressedTexSubImage1D = Load<PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC>(loader,"glCompressedTexSubImage1D");
            _glGetCompressedTexImage = Load<PFNGLGETCOMPRESSEDTEXIMAGEPROC>(loader,"glGetCompressedTexImage");
            _glBlendFuncSeparate = Load<PFNGLBLENDFUNCSEPARATEPROC>(loader,"glBlendFuncSeparate");
            _glMultiDrawArrays = Load<PFNGLMULTIDRAWARRAYSPROC>(loader,"glMultiDrawArrays");
            _glMultiDrawElements = Load<PFNGLMULTIDRAWELEMENTSPROC>(loader,"glMultiDrawElements");
            _glPointParameterf = Load<PFNGLPOINTPARAMETERFPROC>(loader,"glPointParameterf");
            _glPointParameterfv = Load<PFNGLPOINTPARAMETERFVPROC>(loader,"glPointParameterfv");
            _glPointParameteri = Load<PFNGLPOINTPARAMETERIPROC>(loader,"glPointParameteri");
            _glPointParameteriv = Load<PFNGLPOINTPARAMETERIVPROC>(loader,"glPointParameteriv");
            _glBlendColor = Load<PFNGLBLENDCOLORPROC>(loader,"glBlendColor");
            _glBlendEquation = Load<PFNGLBLENDEQUATIONPROC>(loader,"glBlendEquation");
            _glGenQueries = Load<PFNGLGENQUERIESPROC>(loader,"glGenQueries");
            _glDeleteQueries = Load<PFNGLDELETEQUERIESPROC>(loader,"glDeleteQueries");
            _glIsQuery = Load<PFNGLISQUERYPROC>(loader,"glIsQuery");
            _glBeginQuery = Load<PFNGLBEGINQUERYPROC>(loader,"glBeginQuery");
            _glEndQuery = Load<PFNGLENDQUERYPROC>(loader,"glEndQuery");
            _glGetQueryiv = Load<PFNGLGETQUERYIVPROC>(loader,"glGetQueryiv");
            _glGetQueryObjectiv = Load<PFNGLGETQUERYOBJECTIVPROC>(loader,"glGetQueryObjectiv");
            _glGetQueryObjectuiv = Load<PFNGLGETQUERYOBJECTUIVPROC>(loader,"glGetQueryObjectuiv");
            _glBindBuffer = Load<PFNGLBINDBUFFERPROC>(loader,"glBindBuffer");
            _glDeleteBuffers = Load<PFNGLDELETEBUFFERSPROC>(loader,"glDeleteBuffers");
            _glGenBuffers = Load<PFNGLGENBUFFERSPROC>(loader,"glGenBuffers");
            _glIsBuffer = Load<PFNGLISBUFFERPROC>(loader,"glIsBuffer");
            _glBufferData = Load<PFNGLBUFFERDATAPROC>(loader,"glBufferData");
            _glBufferSubData = Load<PFNGLBUFFERSUBDATAPROC>(loader,"glBufferSubData");
            _glGetBufferSubData = Load<PFNGLGETBUFFERSUBDATAPROC>(loader,"glGetBufferSubData");
            _glMapBuffer = Load<PFNGLMAPBUFFERPROC>(loader,"glMapBuffer");
            _glUnmapBuffer = Load<PFNGLUNMAPBUFFERPROC>(loader,"glUnmapBuffer");
            _glGetBufferParameteriv = Load<PFNGLGETBUFFERPARAMETERIVPROC>(loader,"glGetBufferParameteriv");
            _glGetBufferPointerv = Load<PFNGLGETBUFFERPOINTERVPROC>(loader,"glGetBufferPointerv");
            _glBlendEquationSeparate = Load<PFNGLBLENDEQUATIONSEPARATEPROC>(loader,"glBlendEquationSeparate");
            _glDrawBuffers = Load<PFNGLDRAWBUFFERSPROC>(loader,"glDrawBuffers");
            _glStencilOpSeparate = Load<PFNGLSTENCILOPSEPARATEPROC>(loader,"glStencilOpSeparate");
            _glStencilFuncSeparate = Load<PFNGLSTENCILFUNCSEPARATEPROC>(loader,"glStencilFuncSeparate");
            _glStencilMaskSeparate = Load<PFNGLSTENCILMASKSEPARATEPROC>(loader,"glStencilMaskSeparate");
            _glAttachShader = Load<PFNGLATTACHSHADERPROC>(loader,"glAttachShader");
            _glBindAttribLocation = Load<PFNGLBINDATTRIBLOCATIONPROC>(loader,"glBindAttribLocation");
            _glCompileShader = Load<PFNGLCOMPILESHADERPROC>(loader,"glCompileShader");
            _glCreateProgram = Load<PFNGLCREATEPROGRAMPROC>(loader,"glCreateProgram");
            _glCreateShader = Load<PFNGLCREATESHADERPROC>(loader,"glCreateShader");
            _glDeleteProgram = Load<PFNGLDELETEPROGRAMPROC>(loader,"glDeleteProgram");
            _glDeleteShader = Load<PFNGLDELETESHADERPROC>(loader,"glDeleteShader");
            _glDetachShader = Load<PFNGLDETACHSHADERPROC>(loader,"glDetachShader");
            _glDisableVertexAttribArray = Load<PFNGLDISABLEVERTEXATTRIBARRAYPROC>(loader,"glDisableVertexAttribArray");
            _glEnableVertexAttribArray = Load<PFNGLENABLEVERTEXATTRIBARRAYPROC>(loader,"glEnableVertexAttribArray");
            _glGetActiveAttrib = Load<PFNGLGETACTIVEATTRIBPROC>(loader,"glGetActiveAttrib");
            _glGetActiveUniform = Load<PFNGLGETACTIVEUNIFORMPROC>(loader,"glGetActiveUniform");
            _glGetAttachedShaders = Load<PFNGLGETATTACHEDSHADERSPROC>(loader,"glGetAttachedShaders");
            _glGetAttribLocation = Load<PFNGLGETATTRIBLOCATIONPROC>(loader,"glGetAttribLocation");
            _glGetProgramiv = Load<PFNGLGETPROGRAMIVPROC>(loader,"glGetProgramiv");
            _glGetProgramInfoLog = Load<PFNGLGETPROGRAMINFOLOGPROC>(loader,"glGetProgramInfoLog");
            _glGetShaderiv = Load<PFNGLGETSHADERIVPROC>(loader,"glGetShaderiv");
            _glGetShaderInfoLog = Load<PFNGLGETSHADERINFOLOGPROC>(loader,"glGetShaderInfoLog");
            _glGetShaderSource = Load<PFNGLGETSHADERSOURCEPROC>(loader,"glGetShaderSource");
            _glGetUniformLocation = Load<PFNGLGETUNIFORMLOCATIONPROC>(loader,"glGetUniformLocation");
            _glGetUniformfv = Load<PFNGLGETUNIFORMFVPROC>(loader,"glGetUniformfv");
            _glGetUniformiv = Load<PFNGLGETUNIFORMIVPROC>(loader,"glGetUniformiv");
            _glGetVertexAttribdv = Load<PFNGLGETVERTEXATTRIBDVPROC>(loader,"glGetVertexAttribdv");
            _glGetVertexAttribfv = Load<PFNGLGETVERTEXATTRIBFVPROC>(loader,"glGetVertexAttribfv");
            _glGetVertexAttribiv = Load<PFNGLGETVERTEXATTRIBIVPROC>(loader,"glGetVertexAttribiv");
            _glGetVertexAttribPointerv = Load<PFNGLGETVERTEXATTRIBPOINTERVPROC>(loader,"glGetVertexAttribPointerv");
            _glIsProgram = Load<PFNGLISPROGRAMPROC>(loader,"glIsProgram");
            _glIsShader = Load<PFNGLISSHADERPROC>(loader,"glIsShader");
            _glLinkProgram = Load<PFNGLLINKPROGRAMPROC>(loader,"glLinkProgram");
            _glShaderSource = Load<PFNGLSHADERSOURCEPROC>(loader,"glShaderSource");
            _glUseProgram = Load<PFNGLUSEPROGRAMPROC>(loader,"glUseProgram");
            _glUniform1f = Load<PFNGLUNIFORM1FPROC>(loader,"glUniform1f");
            _glUniform2f = Load<PFNGLUNIFORM2FPROC>(loader,"glUniform2f");
            _glUniform3f = Load<PFNGLUNIFORM3FPROC>(loader,"glUniform3f");
            _glUniform4f = Load<PFNGLUNIFORM4FPROC>(loader,"glUniform4f");
            _glUniform1i = Load<PFNGLUNIFORM1IPROC>(loader,"glUniform1i");
            _glUniform2i = Load<PFNGLUNIFORM2IPROC>(loader,"glUniform2i");
            _glUniform3i = Load<PFNGLUNIFORM3IPROC>(loader,"glUniform3i");
            _glUniform4i = Load<PFNGLUNIFORM4IPROC>(loader,"glUniform4i");
            _glUniform1fv = Load<PFNGLUNIFORM1FVPROC>(loader,"glUniform1fv");
            _glUniform2fv = Load<PFNGLUNIFORM2FVPROC>(loader,"glUniform2fv");
            _glUniform3fv = Load<PFNGLUNIFORM3FVPROC>(loader,"glUniform3fv");
            _glUniform4fv = Load<PFNGLUNIFORM4FVPROC>(loader,"glUniform4fv");
            _glUniform1iv = Load<PFNGLUNIFORM1IVPROC>(loader,"glUniform1iv");
            _glUniform2iv = Load<PFNGLUNIFORM2IVPROC>(loader,"glUniform2iv");
            _glUniform3iv = Load<PFNGLUNIFORM3IVPROC>(loader,"glUniform3iv");
            _glUniform4iv = Load<PFNGLUNIFORM4IVPROC>(loader,"glUniform4iv");
            _glUniformMatrix2fv = Load<PFNGLUNIFORMMATRIX2FVPROC>(loader,"glUniformMatrix2fv");
            _glUniformMatrix3fv = Load<PFNGLUNIFORMMATRIX3FVPROC>(loader,"glUniformMatrix3fv");
            _glUniformMatrix4fv = Load<PFNGLUNIFORMMATRIX4FVPROC>(loader,"glUniformMatrix4fv");
            _glValidateProgram = Load<PFNGLVALIDATEPROGRAMPROC>(loader,"glValidateProgram");
            _glVertexAttrib1d = Load<PFNGLVERTEXATTRIB1DPROC>(loader,"glVertexAttrib1d");
            _glVertexAttrib1dv = Load<PFNGLVERTEXATTRIB1DVPROC>(loader,"glVertexAttrib1dv");
            _glVertexAttrib1f = Load<PFNGLVERTEXATTRIB1FPROC>(loader,"glVertexAttrib1f");
            _glVertexAttrib1fv = Load<PFNGLVERTEXATTRIB1FVPROC>(loader,"glVertexAttrib1fv");
            _glVertexAttrib1s = Load<PFNGLVERTEXATTRIB1SPROC>(loader,"glVertexAttrib1s");
            _glVertexAttrib1sv = Load<PFNGLVERTEXATTRIB1SVPROC>(loader,"glVertexAttrib1sv");
            _glVertexAttrib2d = Load<PFNGLVERTEXATTRIB2DPROC>(loader,"glVertexAttrib2d");
            _glVertexAttrib2dv = Load<PFNGLVERTEXATTRIB2DVPROC>(loader,"glVertexAttrib2dv");
            _glVertexAttrib2f = Load<PFNGLVERTEXATTRIB2FPROC>(loader,"glVertexAttrib2f");
            _glVertexAttrib2fv = Load<PFNGLVERTEXATTRIB2FVPROC>(loader,"glVertexAttrib2fv");
            _glVertexAttrib2s = Load<PFNGLVERTEXATTRIB2SPROC>(loader,"glVertexAttrib2s");
            _glVertexAttrib2sv = Load<PFNGLVERTEXATTRIB2SVPROC>(loader,"glVertexAttrib2sv");
            _glVertexAttrib3d = Load<PFNGLVERTEXATTRIB3DPROC>(loader,"glVertexAttrib3d");
            _glVertexAttrib3dv = Load<PFNGLVERTEXATTRIB3DVPROC>(loader,"glVertexAttrib3dv");
            _glVertexAttrib3f = Load<PFNGLVERTEXATTRIB3FPROC>(loader,"glVertexAttrib3f");
            _glVertexAttrib3fv = Load<PFNGLVERTEXATTRIB3FVPROC>(loader,"glVertexAttrib3fv");
            _glVertexAttrib3s = Load<PFNGLVERTEXATTRIB3SPROC>(loader,"glVertexAttrib3s");
            _glVertexAttrib3sv = Load<PFNGLVERTEXATTRIB3SVPROC>(loader,"glVertexAttrib3sv");
            _glVertexAttrib4Nbv = Load<PFNGLVERTEXATTRIB4NBVPROC>(loader,"glVertexAttrib4Nbv");
            _glVertexAttrib4Niv = Load<PFNGLVERTEXATTRIB4NIVPROC>(loader,"glVertexAttrib4Niv");
            _glVertexAttrib4Nsv = Load<PFNGLVERTEXATTRIB4NSVPROC>(loader,"glVertexAttrib4Nsv");
            _glVertexAttrib4Nub = Load<PFNGLVERTEXATTRIB4NUBPROC>(loader,"glVertexAttrib4Nub");
            _glVertexAttrib4Nubv = Load<PFNGLVERTEXATTRIB4NUBVPROC>(loader,"glVertexAttrib4Nubv");
            _glVertexAttrib4Nuiv = Load<PFNGLVERTEXATTRIB4NUIVPROC>(loader,"glVertexAttrib4Nuiv");
            _glVertexAttrib4Nusv = Load<PFNGLVERTEXATTRIB4NUSVPROC>(loader,"glVertexAttrib4Nusv");
            _glVertexAttrib4bv = Load<PFNGLVERTEXATTRIB4BVPROC>(loader,"glVertexAttrib4bv");
            _glVertexAttrib4d = Load<PFNGLVERTEXATTRIB4DPROC>(loader,"glVertexAttrib4d");
            _glVertexAttrib4dv = Load<PFNGLVERTEXATTRIB4DVPROC>(loader,"glVertexAttrib4dv");
            _glVertexAttrib4f = Load<PFNGLVERTEXATTRIB4FPROC>(loader,"glVertexAttrib4f");
            _glVertexAttrib4fv = Load<PFNGLVERTEXATTRIB4FVPROC>(loader,"glVertexAttrib4fv");
            _glVertexAttrib4iv = Load<PFNGLVERTEXATTRIB4IVPROC>(loader,"glVertexAttrib4iv");
            _glVertexAttrib4s = Load<PFNGLVERTEXATTRIB4SPROC>(loader,"glVertexAttrib4s");
            _glVertexAttrib4sv = Load<PFNGLVERTEXATTRIB4SVPROC>(loader,"glVertexAttrib4sv");
            _glVertexAttrib4ubv = Load<PFNGLVERTEXATTRIB4UBVPROC>(loader,"glVertexAttrib4ubv");
            _glVertexAttrib4uiv = Load<PFNGLVERTEXATTRIB4UIVPROC>(loader,"glVertexAttrib4uiv");
            _glVertexAttrib4usv = Load<PFNGLVERTEXATTRIB4USVPROC>(loader,"glVertexAttrib4usv");
            _glVertexAttribPointer = Load<PFNGLVERTEXATTRIBPOINTERPROC>(loader,"glVertexAttribPointer");
            _glUniformMatrix2x3fv = Load<PFNGLUNIFORMMATRIX2X3FVPROC>(loader,"glUniformMatrix2x3fv");
            _glUniformMatrix3x2fv = Load<PFNGLUNIFORMMATRIX3X2FVPROC>(loader,"glUniformMatrix3x2fv");
            _glUniformMatrix2x4fv = Load<PFNGLUNIFORMMATRIX2X4FVPROC>(loader,"glUniformMatrix2x4fv");
            _glUniformMatrix4x2fv = Load<PFNGLUNIFORMMATRIX4X2FVPROC>(loader,"glUniformMatrix4x2fv");
            _glUniformMatrix3x4fv = Load<PFNGLUNIFORMMATRIX3X4FVPROC>(loader,"glUniformMatrix3x4fv");
            _glUniformMatrix4x3fv = Load<PFNGLUNIFORMMATRIX4X3FVPROC>(loader,"glUniformMatrix4x3fv");
            _glColorMaski = Load<PFNGLCOLORMASKIPROC>(loader,"glColorMaski");
            _glGetBooleani_v = Load<PFNGLGETBOOLEANI_VPROC>(loader,"glGetBooleani_v");
            _glGetIntegeri_v = Load<PFNGLGETINTEGERI_VPROC>(loader,"glGetIntegeri_v");
            _glEnablei = Load<PFNGLENABLEIPROC>(loader,"glEnablei");
            _glDisablei = Load<PFNGLDISABLEIPROC>(loader,"glDisablei");
            _glIsEnabledi = Load<PFNGLISENABLEDIPROC>(loader,"glIsEnabledi");
            _glBeginTransformFeedback = Load<PFNGLBEGINTRANSFORMFEEDBACKPROC>(loader,"glBeginTransformFeedback");
            _glEndTransformFeedback = Load<PFNGLENDTRANSFORMFEEDBACKPROC>(loader,"glEndTransformFeedback");
            _glBindBufferRange = Load<PFNGLBINDBUFFERRANGEPROC>(loader,"glBindBufferRange");
            _glBindBufferBase = Load<PFNGLBINDBUFFERBASEPROC>(loader,"glBindBufferBase");
            _glTransformFeedbackVaryings = Load<PFNGLTRANSFORMFEEDBACKVARYINGSPROC>(loader,"glTransformFeedbackVaryings");
            _glGetTransformFeedbackVarying = Load<PFNGLGETTRANSFORMFEEDBACKVARYINGPROC>(loader,"glGetTransformFeedbackVarying");
            _glClampColor = Load<PFNGLCLAMPCOLORPROC>(loader,"glClampColor");
            _glBeginConditionalRender = Load<PFNGLBEGINCONDITIONALRENDERPROC>(loader,"glBeginConditionalRender");
            _glEndConditionalRender = Load<PFNGLENDCONDITIONALRENDERPROC>(loader,"glEndConditionalRender");
            _glVertexAttribIPointer = Load<PFNGLVERTEXATTRIBIPOINTERPROC>(loader,"glVertexAttribIPointer");
            _glGetVertexAttribIiv = Load<PFNGLGETVERTEXATTRIBIIVPROC>(loader,"glGetVertexAttribIiv");
            _glGetVertexAttribIuiv = Load<PFNGLGETVERTEXATTRIBIUIVPROC>(loader,"glGetVertexAttribIuiv");
            _glVertexAttribI1i = Load<PFNGLVERTEXATTRIBI1IPROC>(loader,"glVertexAttribI1i");
            _glVertexAttribI2i = Load<PFNGLVERTEXATTRIBI2IPROC>(loader,"glVertexAttribI2i");
            _glVertexAttribI3i = Load<PFNGLVERTEXATTRIBI3IPROC>(loader,"glVertexAttribI3i");
            _glVertexAttribI4i = Load<PFNGLVERTEXATTRIBI4IPROC>(loader,"glVertexAttribI4i");
            _glVertexAttribI1ui = Load<PFNGLVERTEXATTRIBI1UIPROC>(loader,"glVertexAttribI1ui");
            _glVertexAttribI2ui = Load<PFNGLVERTEXATTRIBI2UIPROC>(loader,"glVertexAttribI2ui");
            _glVertexAttribI3ui = Load<PFNGLVERTEXATTRIBI3UIPROC>(loader,"glVertexAttribI3ui");
            _glVertexAttribI4ui = Load<PFNGLVERTEXATTRIBI4UIPROC>(loader,"glVertexAttribI4ui");
            _glVertexAttribI1iv = Load<PFNGLVERTEXATTRIBI1IVPROC>(loader,"glVertexAttribI1iv");
            _glVertexAttribI2iv = Load<PFNGLVERTEXATTRIBI2IVPROC>(loader,"glVertexAttribI2iv");
            _glVertexAttribI3iv = Load<PFNGLVERTEXATTRIBI3IVPROC>(loader,"glVertexAttribI3iv");
            _glVertexAttribI4iv = Load<PFNGLVERTEXATTRIBI4IVPROC>(loader,"glVertexAttribI4iv");
            _glVertexAttribI1uiv = Load<PFNGLVERTEXATTRIBI1UIVPROC>(loader,"glVertexAttribI1uiv");
            _glVertexAttribI2uiv = Load<PFNGLVERTEXATTRIBI2UIVPROC>(loader,"glVertexAttribI2uiv");
            _glVertexAttribI3uiv = Load<PFNGLVERTEXATTRIBI3UIVPROC>(loader,"glVertexAttribI3uiv");
            _glVertexAttribI4uiv = Load<PFNGLVERTEXATTRIBI4UIVPROC>(loader,"glVertexAttribI4uiv");
            _glVertexAttribI4bv = Load<PFNGLVERTEXATTRIBI4BVPROC>(loader,"glVertexAttribI4bv");
            _glVertexAttribI4sv = Load<PFNGLVERTEXATTRIBI4SVPROC>(loader,"glVertexAttribI4sv");
            _glVertexAttribI4ubv = Load<PFNGLVERTEXATTRIBI4UBVPROC>(loader,"glVertexAttribI4ubv");
            _glVertexAttribI4usv = Load<PFNGLVERTEXATTRIBI4USVPROC>(loader,"glVertexAttribI4usv");
            _glGetUniformuiv = Load<PFNGLGETUNIFORMUIVPROC>(loader,"glGetUniformuiv");
            _glBindFragDataLocation = Load<PFNGLBINDFRAGDATALOCATIONPROC>(loader,"glBindFragDataLocation");
            _glGetFragDataLocation = Load<PFNGLGETFRAGDATALOCATIONPROC>(loader,"glGetFragDataLocation");
            _glUniform1ui = Load<PFNGLUNIFORM1UIPROC>(loader,"glUniform1ui");
            _glUniform2ui = Load<PFNGLUNIFORM2UIPROC>(loader,"glUniform2ui");
            _glUniform3ui = Load<PFNGLUNIFORM3UIPROC>(loader,"glUniform3ui");
            _glUniform4ui = Load<PFNGLUNIFORM4UIPROC>(loader,"glUniform4ui");
            _glUniform1uiv = Load<PFNGLUNIFORM1UIVPROC>(loader,"glUniform1uiv");
            _glUniform2uiv = Load<PFNGLUNIFORM2UIVPROC>(loader,"glUniform2uiv");
            _glUniform3uiv = Load<PFNGLUNIFORM3UIVPROC>(loader,"glUniform3uiv");
            _glUniform4uiv = Load<PFNGLUNIFORM4UIVPROC>(loader,"glUniform4uiv");
            _glTexParameterIiv = Load<PFNGLTEXPARAMETERIIVPROC>(loader,"glTexParameterIiv");
            _glTexParameterIuiv = Load<PFNGLTEXPARAMETERIUIVPROC>(loader,"glTexParameterIuiv");
            _glGetTexParameterIiv = Load<PFNGLGETTEXPARAMETERIIVPROC>(loader,"glGetTexParameterIiv");
            _glGetTexParameterIuiv = Load<PFNGLGETTEXPARAMETERIUIVPROC>(loader,"glGetTexParameterIuiv");
            _glClearBufferiv = Load<PFNGLCLEARBUFFERIVPROC>(loader,"glClearBufferiv");
            _glClearBufferuiv = Load<PFNGLCLEARBUFFERUIVPROC>(loader,"glClearBufferuiv");
            _glClearBufferfv = Load<PFNGLCLEARBUFFERFVPROC>(loader,"glClearBufferfv");
            _glClearBufferfi = Load<PFNGLCLEARBUFFERFIPROC>(loader,"glClearBufferfi");
            _glGetStringi = Load<PFNGLGETSTRINGIPROC>(loader,"glGetStringi");
            _glIsRenderbuffer = Load<PFNGLISRENDERBUFFERPROC>(loader,"glIsRenderbuffer");
            _glBindRenderbuffer = Load<PFNGLBINDRENDERBUFFERPROC>(loader,"glBindRenderbuffer");
            _glDeleteRenderbuffers = Load<PFNGLDELETERENDERBUFFERSPROC>(loader,"glDeleteRenderbuffers");
            _glGenRenderbuffers = Load<PFNGLGENRENDERBUFFERSPROC>(loader,"glGenRenderbuffers");
            _glRenderbufferStorage = Load<PFNGLRENDERBUFFERSTORAGEPROC>(loader,"glRenderbufferStorage");
            _glGetRenderbufferParameteriv = Load<PFNGLGETRENDERBUFFERPARAMETERIVPROC>(loader,"glGetRenderbufferParameteriv");
            _glIsFramebuffer = Load<PFNGLISFRAMEBUFFERPROC>(loader,"glIsFramebuffer");
            _glBindFramebuffer = Load<PFNGLBINDFRAMEBUFFERPROC>(loader,"glBindFramebuffer");
            _glDeleteFramebuffers = Load<PFNGLDELETEFRAMEBUFFERSPROC>(loader,"glDeleteFramebuffers");
            _glGenFramebuffers = Load<PFNGLGENFRAMEBUFFERSPROC>(loader,"glGenFramebuffers");
            _glCheckFramebufferStatus = Load<PFNGLCHECKFRAMEBUFFERSTATUSPROC>(loader,"glCheckFramebufferStatus");
            _glFramebufferTexture1D = Load<PFNGLFRAMEBUFFERTEXTURE1DPROC>(loader,"glFramebufferTexture1D");
            _glFramebufferTexture2D = Load<PFNGLFRAMEBUFFERTEXTURE2DPROC>(loader,"glFramebufferTexture2D");
            _glFramebufferTexture3D = Load<PFNGLFRAMEBUFFERTEXTURE3DPROC>(loader,"glFramebufferTexture3D");
            _glFramebufferRenderbuffer = Load<PFNGLFRAMEBUFFERRENDERBUFFERPROC>(loader,"glFramebufferRenderbuffer");
            _glGetFramebufferAttachmentParameteriv = Load<PFNGLGETFRAMEBUFFERATTACHMENTPARAMETERIVPROC>(loader,"glGetFramebufferAttachmentParameteriv");
            _glGenerateMipmap = Load<PFNGLGENERATEMIPMAPPROC>(loader,"glGenerateMipmap");
            _glBlitFramebuffer = Load<PFNGLBLITFRAMEBUFFERPROC>(loader,"glBlitFramebuffer");
            _glRenderbufferStorageMultisample = Load<PFNGLRENDERBUFFERSTORAGEMULTISAMPLEPROC>(loader,"glRenderbufferStorageMultisample");
            _glFramebufferTextureLayer = Load<PFNGLFRAMEBUFFERTEXTURELAYERPROC>(loader,"glFramebufferTextureLayer");
            _glMapBufferRange = Load<PFNGLMAPBUFFERRANGEPROC>(loader,"glMapBufferRange");
            _glFlushMappedBufferRange = Load<PFNGLFLUSHMAPPEDBUFFERRANGEPROC>(loader,"glFlushMappedBufferRange");
            _glBindVertexArray = Load<PFNGLBINDVERTEXARRAYPROC>(loader,"glBindVertexArray");
            _glDeleteVertexArrays = Load<PFNGLDELETEVERTEXARRAYSPROC>(loader,"glDeleteVertexArrays");
            _glGenVertexArrays = Load<PFNGLGENVERTEXARRAYSPROC>(loader,"glGenVertexArrays");
            _glIsVertexArray = Load<PFNGLISVERTEXARRAYPROC>(loader,"glIsVertexArray");
            _glDrawArraysInstanced = Load<PFNGLDRAWARRAYSINSTANCEDPROC>(loader,"glDrawArraysInstanced");
            _glDrawElementsInstanced = Load<PFNGLDRAWELEMENTSINSTANCEDPROC>(loader,"glDrawElementsInstanced");
            _glTexBuffer = Load<PFNGLTEXBUFFERPROC>(loader,"glTexBuffer");
            _glPrimitiveRestartIndex = Load<PFNGLPRIMITIVERESTARTINDEXPROC>(loader,"glPrimitiveRestartIndex");
            _glCopyBufferSubData = Load<PFNGLCOPYBUFFERSUBDATAPROC>(loader,"glCopyBufferSubData");
            _glGetUniformIndices = Load<PFNGLGETUNIFORMINDICESPROC>(loader,"glGetUniformIndices");
            _glGetActiveUniformsiv = Load<PFNGLGETACTIVEUNIFORMSIVPROC>(loader,"glGetActiveUniformsiv");
            _glGetActiveUniformName = Load<PFNGLGETACTIVEUNIFORMNAMEPROC>(loader,"glGetActiveUniformName");
            _glGetUniformBlockIndex = Load<PFNGLGETUNIFORMBLOCKINDEXPROC>(loader,"glGetUniformBlockIndex");
            _glGetActiveUniformBlockiv = Load<PFNGLGETACTIVEUNIFORMBLOCKIVPROC>(loader,"glGetActiveUniformBlockiv");
            _glGetActiveUniformBlockName = Load<PFNGLGETACTIVEUNIFORMBLOCKNAMEPROC>(loader,"glGetActiveUniformBlockName");
            _glUniformBlockBinding = Load<PFNGLUNIFORMBLOCKBINDINGPROC>(loader,"glUniformBlockBinding");
            _glBindBufferRange = Load<PFNGLBINDBUFFERRANGEPROC>(loader,"glBindBufferRange");
            _glBindBufferBase = Load<PFNGLBINDBUFFERBASEPROC>(loader,"glBindBufferBase");
            _glGetIntegeri_v = Load<PFNGLGETINTEGERI_VPROC>(loader,"glGetIntegeri_v");
            _glDrawElementsBaseVertex = Load<PFNGLDRAWELEMENTSBASEVERTEXPROC>(loader,"glDrawElementsBaseVertex");
            _glDrawRangeElementsBaseVertex = Load<PFNGLDRAWRANGEELEMENTSBASEVERTEXPROC>(loader,"glDrawRangeElementsBaseVertex");
            _glDrawElementsInstancedBaseVertex = Load<PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXPROC>(loader,"glDrawElementsInstancedBaseVertex");
            _glMultiDrawElementsBaseVertex = Load<PFNGLMULTIDRAWELEMENTSBASEVERTEXPROC>(loader,"glMultiDrawElementsBaseVertex");
            _glProvokingVertex = Load<PFNGLPROVOKINGVERTEXPROC>(loader,"glProvokingVertex");
            _glFenceSync = Load<PFNGLFENCESYNCPROC>(loader,"glFenceSync");
            _glIsSync = Load<PFNGLISSYNCPROC>(loader,"glIsSync");
            _glDeleteSync = Load<PFNGLDELETESYNCPROC>(loader,"glDeleteSync");
            _glClientWaitSync = Load<PFNGLCLIENTWAITSYNCPROC>(loader,"glClientWaitSync");
            _glWaitSync = Load<PFNGLWAITSYNCPROC>(loader,"glWaitSync");
            _glGetInteger64v = Load<PFNGLGETINTEGER64VPROC>(loader,"glGetInteger64v");
            _glGetSynciv = Load<PFNGLGETSYNCIVPROC>(loader,"glGetSynciv");
            _glGetInteger64i_v = Load<PFNGLGETINTEGER64I_VPROC>(loader,"glGetInteger64i_v");
            _glGetBufferParameteri64v = Load<PFNGLGETBUFFERPARAMETERI64VPROC>(loader,"glGetBufferParameteri64v");
            _glFramebufferTexture = Load<PFNGLFRAMEBUFFERTEXTUREPROC>(loader,"glFramebufferTexture");
            _glTexImage2DMultisample = Load<PFNGLTEXIMAGE2DMULTISAMPLEPROC>(loader,"glTexImage2DMultisample");
            _glTexImage3DMultisample = Load<PFNGLTEXIMAGE3DMULTISAMPLEPROC>(loader,"glTexImage3DMultisample");
            _glGetMultisamplefv = Load<PFNGLGETMULTISAMPLEFVPROC>(loader,"glGetMultisamplefv");
            _glSampleMaski = Load<PFNGLSAMPLEMASKIPROC>(loader,"glSampleMaski");
            _glBindFragDataLocationIndexed = Load<PFNGLBINDFRAGDATALOCATIONINDEXEDPROC>(loader,"glBindFragDataLocationIndexed");
            _glGetFragDataIndex = Load<PFNGLGETFRAGDATAINDEXPROC>(loader,"glGetFragDataIndex");
            _glGenSamplers = Load<PFNGLGENSAMPLERSPROC>(loader,"glGenSamplers");
            _glDeleteSamplers = Load<PFNGLDELETESAMPLERSPROC>(loader,"glDeleteSamplers");
            _glIsSampler = Load<PFNGLISSAMPLERPROC>(loader,"glIsSampler");
            _glBindSampler = Load<PFNGLBINDSAMPLERPROC>(loader,"glBindSampler");
            _glSamplerParameteri = Load<PFNGLSAMPLERPARAMETERIPROC>(loader,"glSamplerParameteri");
            _glSamplerParameteriv = Load<PFNGLSAMPLERPARAMETERIVPROC>(loader,"glSamplerParameteriv");
            _glSamplerParameterf = Load<PFNGLSAMPLERPARAMETERFPROC>(loader,"glSamplerParameterf");
            _glSamplerParameterfv = Load<PFNGLSAMPLERPARAMETERFVPROC>(loader,"glSamplerParameterfv");
            _glSamplerParameterIiv = Load<PFNGLSAMPLERPARAMETERIIVPROC>(loader,"glSamplerParameterIiv");
            _glSamplerParameterIuiv = Load<PFNGLSAMPLERPARAMETERIUIVPROC>(loader,"glSamplerParameterIuiv");
            _glGetSamplerParameteriv = Load<PFNGLGETSAMPLERPARAMETERIVPROC>(loader,"glGetSamplerParameteriv");
            _glGetSamplerParameterIiv = Load<PFNGLGETSAMPLERPARAMETERIIVPROC>(loader,"glGetSamplerParameterIiv");
            _glGetSamplerParameterfv = Load<PFNGLGETSAMPLERPARAMETERFVPROC>(loader,"glGetSamplerParameterfv");
            _glGetSamplerParameterIuiv = Load<PFNGLGETSAMPLERPARAMETERIUIVPROC>(loader,"glGetSamplerParameterIuiv");
            _glQueryCounter = Load<PFNGLQUERYCOUNTERPROC>(loader,"glQueryCounter");
            _glGetQueryObjecti64v = Load<PFNGLGETQUERYOBJECTI64VPROC>(loader,"glGetQueryObjecti64v");
            _glGetQueryObjectui64v = Load<PFNGLGETQUERYOBJECTUI64VPROC>(loader,"glGetQueryObjectui64v");
            _glVertexAttribDivisor = Load<PFNGLVERTEXATTRIBDIVISORPROC>(loader,"glVertexAttribDivisor");
            _glVertexAttribP1ui = Load<PFNGLVERTEXATTRIBP1UIPROC>(loader,"glVertexAttribP1ui");
            _glVertexAttribP1uiv = Load<PFNGLVERTEXATTRIBP1UIVPROC>(loader,"glVertexAttribP1uiv");
            _glVertexAttribP2ui = Load<PFNGLVERTEXATTRIBP2UIPROC>(loader,"glVertexAttribP2ui");
            _glVertexAttribP2uiv = Load<PFNGLVERTEXATTRIBP2UIVPROC>(loader,"glVertexAttribP2uiv");
            _glVertexAttribP3ui = Load<PFNGLVERTEXATTRIBP3UIPROC>(loader,"glVertexAttribP3ui");
            _glVertexAttribP3uiv = Load<PFNGLVERTEXATTRIBP3UIVPROC>(loader,"glVertexAttribP3uiv");
            _glVertexAttribP4ui = Load<PFNGLVERTEXATTRIBP4UIPROC>(loader,"glVertexAttribP4ui");
            _glVertexAttribP4uiv = Load<PFNGLVERTEXATTRIBP4UIVPROC>(loader,"glVertexAttribP4uiv");
            _glVertexP2ui = Load<PFNGLVERTEXP2UIPROC>(loader,"glVertexP2ui");
            _glVertexP2uiv = Load<PFNGLVERTEXP2UIVPROC>(loader,"glVertexP2uiv");
            _glVertexP3ui = Load<PFNGLVERTEXP3UIPROC>(loader,"glVertexP3ui");
            _glVertexP3uiv = Load<PFNGLVERTEXP3UIVPROC>(loader,"glVertexP3uiv");
            _glVertexP4ui = Load<PFNGLVERTEXP4UIPROC>(loader,"glVertexP4ui");
            _glVertexP4uiv = Load<PFNGLVERTEXP4UIVPROC>(loader,"glVertexP4uiv");
            _glTexCoordP1ui = Load<PFNGLTEXCOORDP1UIPROC>(loader,"glTexCoordP1ui");
            _glTexCoordP1uiv = Load<PFNGLTEXCOORDP1UIVPROC>(loader,"glTexCoordP1uiv");
            _glTexCoordP2ui = Load<PFNGLTEXCOORDP2UIPROC>(loader,"glTexCoordP2ui");
            _glTexCoordP2uiv = Load<PFNGLTEXCOORDP2UIVPROC>(loader,"glTexCoordP2uiv");
            _glTexCoordP3ui = Load<PFNGLTEXCOORDP3UIPROC>(loader,"glTexCoordP3ui");
            _glTexCoordP3uiv = Load<PFNGLTEXCOORDP3UIVPROC>(loader,"glTexCoordP3uiv");
            _glTexCoordP4ui = Load<PFNGLTEXCOORDP4UIPROC>(loader,"glTexCoordP4ui");
            _glTexCoordP4uiv = Load<PFNGLTEXCOORDP4UIVPROC>(loader,"glTexCoordP4uiv");
            _glMultiTexCoordP1ui = Load<PFNGLMULTITEXCOORDP1UIPROC>(loader,"glMultiTexCoordP1ui");
            _glMultiTexCoordP1uiv = Load<PFNGLMULTITEXCOORDP1UIVPROC>(loader,"glMultiTexCoordP1uiv");
            _glMultiTexCoordP2ui = Load<PFNGLMULTITEXCOORDP2UIPROC>(loader,"glMultiTexCoordP2ui");
            _glMultiTexCoordP2uiv = Load<PFNGLMULTITEXCOORDP2UIVPROC>(loader,"glMultiTexCoordP2uiv");
            _glMultiTexCoordP3ui = Load<PFNGLMULTITEXCOORDP3UIPROC>(loader,"glMultiTexCoordP3ui");
            _glMultiTexCoordP3uiv = Load<PFNGLMULTITEXCOORDP3UIVPROC>(loader,"glMultiTexCoordP3uiv");
            _glMultiTexCoordP4ui = Load<PFNGLMULTITEXCOORDP4UIPROC>(loader,"glMultiTexCoordP4ui");
            _glMultiTexCoordP4uiv = Load<PFNGLMULTITEXCOORDP4UIVPROC>(loader,"glMultiTexCoordP4uiv");
            _glNormalP3ui = Load<PFNGLNORMALP3UIPROC>(loader,"glNormalP3ui");
            _glNormalP3uiv = Load<PFNGLNORMALP3UIVPROC>(loader,"glNormalP3uiv");
            _glColorP3ui = Load<PFNGLCOLORP3UIPROC>(loader,"glColorP3ui");
            _glColorP3uiv = Load<PFNGLCOLORP3UIVPROC>(loader,"glColorP3uiv");
            _glColorP4ui = Load<PFNGLCOLORP4UIPROC>(loader,"glColorP4ui");
            _glColorP4uiv = Load<PFNGLCOLORP4UIVPROC>(loader,"glColorP4uiv");
            _glSecondaryColorP3ui = Load<PFNGLSECONDARYCOLORP3UIPROC>(loader,"glSecondaryColorP3ui");
            _glSecondaryColorP3uiv = Load<PFNGLSECONDARYCOLORP3UIVPROC>(loader,"glSecondaryColorP3uiv");
        }
    }
}