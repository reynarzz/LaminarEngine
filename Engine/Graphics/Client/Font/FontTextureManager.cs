...
namespace Engine.Graphics
{
    internal class FontTextureManager : ITexture2DManager
    {
        ...
        {
            return new Texture2D(TextureWrapMode.Clamp, TextureFilterMode.Nearest, width, height, 4, null);
        }
        ...
        public void SetTextureData(object texture, Rectangle bounds, byte[] data)
        {
            ...
            GfxDeviceManager.Current.UpdateResource(tex2D.NativeResource, _sharedDescriptor);
        }
    }
}
