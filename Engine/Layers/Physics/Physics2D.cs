...
namespace Engine
{
    ...
    public static partial class Physics2D
    {
        ...
        private struct CastContext : Box2dUtils.ICastContext
        {
            public CastHit2D Hit { get; set; }
        ...
        private static float CastResultFunc<T>(B2ShapeId shapeId, B2Vec2 point, B2Vec2 normal, float fraction, ref T context) where T : struct, Box2dUtils.ICastContext
        {
